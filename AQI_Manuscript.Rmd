...
3. mixed effects Bayesian models.  

We wanted to investigate if any potential association between socioeconomic status and antiemetic utilization depended on the mode of analysis or on the inclusion or exclusion of potential confounders. We used mixed effects model to control for the potential confounding influence of procedure type or provider behavior.
