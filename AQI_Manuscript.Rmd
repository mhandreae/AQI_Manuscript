...
We found  statistically significant differences (p<0.001) in all demographic bivariate comparisons; results suggested that patients who received ondansetron were on average younger, as expected considering their higher risk for PONY (postoperative nausea and vomiting). Ondansetron was more frequently given to women, as expected given that women have a higher risk for PONY. Ondansetron was more often used in longer cases, and in outpatients, and less during emergency surgery, and more frequently if the patient lived in a zip code with higher mean income and smaller population size. 
