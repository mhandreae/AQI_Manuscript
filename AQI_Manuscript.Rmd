...
csl: Bibliography/anesthesiology.csl
fontfamily: pslatex
output:
...
Michael Andreae, MD, Email: mandreae@montefiore.org, Tel: +1 (718)920 2802, Address: Department of Anesthesiology, Montefiore Medical Center, 111 E 210th Street, Bronx, NY 10467
...
## Healthcare disparities persist in the United States
The healthcare disparities in the United States of America described decades ago by Gornick[@Gornick_8703185], unabatedly persist to the present[@Schoen_24226092] and are linked to social determinants of health and equality[@Cooper_22566148]. Strikingly, compared to Caucasians, life expectancy for African Americans is almost 4 years shorter[@Kochanek_24152376]. The medical profession cannot and will not accept this grave inequality which contradicts basic principles of medical ethics[@IOM_2003]. Poverty, poor education, differences in medical insurance coverage, geographic location, legal or social status, race & gender, patient and community attitudes & perceptions and, last but not least, provider bias might lead to healthcare disparities also in anesthesia[@Silber_23719571]. This paper investigates if antiemetic utilization (AU) as a marker of quality anesthesia care is predicted by socioeconomic status (measured by insurance status and median income in the patients' home zip code) in the large National Anesthesia Clinical Outcomes Registry (NACOR)[@Dutton_21871404]. 

## Healthcare disparities pervade surgery, anesthesia, and pain medicine

A systematic review by Haider suggested that insurance status, median income, race and ethnicity, and socioeconomic status predict trauma outcomes, independent of injury type[@Haider_23609267]. LaPar showed that Medicaid and uninsured payer status confer increased risk-adjusted mortality for major surgery in the National Inpatient Database [@LaPar2010]. Already in 1977, Egbert described race as a predictor to receive treatment from a resident surgeon as opposed to a fully trained attending[@Egbert_325411]. Resident surgeons involvement can lead to longer case duration[@Silber_23719571], which in turn can increase infection rates[@Campbell_19183526]. Black patients are at higher risk for poor outcomes after diverticulitis surgery, especially in emergency cases[@Alavi_22125173]. Minorities are more likely to be treated by surgeons with lower surgical volumes, with the latter being linked to poorer outcomes[@Haider_23318117]. The surgical approach may differ with whites more likely to receive less invasive minimal surgery[@Ricciardi_18594921]. Do similar mechanisms lead to healthcare disparities also in anesthesia? A systematic review and meta-analysis by Meghani raises alarm about the persistent racial and ethnic disparities in the treatment of pain, clearly a domain of anesthesiologists[@Meghani_22239747]. We described language as barrier to access chronic pain services[@Shaparin_24747766]. Jimenez found disparities in pain treatment in children[@Jimenez_20173265]. The literature on anesthesia related health disparities[@Silber_23719571] seems sparse, apart from labor analgesia[@Toledo_22075013; @Glance_17197841; @Rust_15343221; @Elisha_22403965] and pain medicine. Given the central contribution of anesthesiologist on perioperativee outcomes[@Glance2015;@Gaba_10720368;@Leape_7503827;@Silber_10861159]. 
...
We propose to investigate antiemetic utilization (AU) as a surrogate marker of quality of anesthesia care. Three characteristics make AU a good surrogate marker. (1) AU is independence of patient characteristics (comorbidity, genetic disease, health status, ability to pay, patient attitudes and choices, income, education level, geographic location) (2) AU is the sole esponsibility of anesthesia providers.(3) AU is not influenced by regulatory, monetary or insurance constraints and has a an accepted standard of care [@Apfel_15190136]. There are two principle choices of antiemetic prophylaxis, (a) ondansetron and (b) dexamethason. (a) Ondansetron is still under patent protection and therefore costly; its administration may be constraint by monetary considerations. Ondansetron is contraindicated in certain cardiac conditions (QT prolongation). (b) Dexamethason is off patent, widely available, extremely cheap and without any contraindications. *Either* of the two antiemetic agents should be available and suitable for prophylaxis of postoperative nausea and vomiting (PONY), if indicated in any given patient.

## Hypothesis

Socioeconomic status predicts antiemetic utilization as a surrogate marker of anesthesia quality, in the subset of the National Anesthesia Outcome Registry (NACOR) with full electronic anesthesia records[@Dutton_21871404], after allowing for institutional and geographic variability, patient preoperative riskfactors, procedure and anesthesia type and controlling for individual provider behavior. 
