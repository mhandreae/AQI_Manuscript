...
## Significance
Does healthcare disparities exist also in anesthesia? A systematic review and meta-analysis by Meghani raises alarm about the persistent racial and ethnic disparities in the treatment of pain, clearly a domain of anesthesiologists[@Meghani_22239747]. We described language as barrier to access chronic pain services[@Shaparin_24747766]. Jimenez found disparities in pain treatment in children[@Jimenez_20173265]. Unfortunately, apart from labor analgesia[@Toledo_22075013; @Glance_17197841; @Rust_15343221; @Elisha_22403965] and pain medicine[@Glance2015;@Gaba_10720368;@Leape_7503827;@Silber_10861159], the literature on anesthesia related health disparities seems sparse[@Silber_23719571]. 

## Objective

We propose to investigate antiemetic utilization (AU) as a marker of quality anesthesia care. Three characteristics make AU a good marker: 

1. AU is relatively independent of patient characteristics (e.g. genetic disease, ability to pay or geographic location), 
2. AU is the sole esponsibility of anesthesia providers,
3. AU is not influenced by regulatory, monetary or insurance constraints and has a an accepted standard of care [@Apfel_15190136].

This paper investigates if antiemetic utilization is predicted by socioeconomic status, [insurance status or median income in the patients' home zip code]. We explore this association in the subset of the National Anesthesia Clinical Outcomes Registry (NACOR) with full electronic anesthesia reporting antiemetic adminstration [@Dutton_21871404].
