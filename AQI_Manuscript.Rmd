...
We explored the preponderance for antiemetic prophylaxis contingent on patient demogrpahics in [Table 2 Predictors of antiemetic prophylxis]. The prevalence of ondansetron administration for different insurance status is  described in [Table 3 Insurance status versus antiemetic prophylaxis]. Clearly,  Patients who have commercial insurance are more likely to receive antiemetic prophylaxis than those who have medicaid.
...
We show the results of our final logistic regression model in the [Table 3 Logistic regression]. Being on medicaid or medicare, compared to having commercial insurance, drastically reduces the odds of receiving ondansetron during anesthesia. For the average patient on medicaid or medicare, the odds of receiving ondansetron for anti-emetic prophylaxis are 0.6 compared to a patient with commercial insurance with otherwise similar characteristics, even after controlling for age and gender, case duration, median income and population in the patient's home zip code. 
...
## Table 6  Bayesian model {#Bayesian_table}
